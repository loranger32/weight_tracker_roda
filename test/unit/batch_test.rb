...
class BatchBasicTest < HookedTestClass
  def load_fixtures
    ...
    Entry.new(day: "2020-12-01", weight: "51.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 1).save
    Entry.new(day: "2020-12-02", weight: "52.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 1).save
  end
...
class BatchAdvancedTest < HookedTestClass
  def load_fixtures
    ...
    Entry.new(day: "2020-11-01", weight: "51.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 1).save
    Entry.new(day: "2020-11-02", weight: "54.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 1).save
    Entry.new(day: "2020-12-01", weight: "51.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 2).save
    Entry.new(day: "2020-12-02", weight: "52.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 2).save
    Entry.new(day: "2020-12-03", weight: "53.0", note: "", alcohol_consumption: "none", sport: "none", account_id: 1, batch_id: 2).save
